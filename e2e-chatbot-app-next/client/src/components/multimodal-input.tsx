        ...
        >
          ...
          <PromptInputToolbar className="!border-top-0 border-t-0! p-0 shadow-none dark:border-0 dark:border-transparent!">
            <PromptInputTools className="gap-0 sm:gap-0.5">
              <label
                className="flex cursor-pointer items-center gap-1.5 rounded-md px-2 py-1 text-xs text-muted-foreground transition-colors hover:text-foreground"
                title="Enable for tasks that take longer than 2 minutes"
              >
                <input
                  type="checkbox"
...
export const MultimodalInput = memo(
  ...
  (prevProps, nextProps) => {
    ...
    if (prevProps.selectedVisibilityType !== nextProps.selectedVisibilityType)
      return false;
    if (prevProps.backgroundMode !== nextProps.backgroundMode) return false;
